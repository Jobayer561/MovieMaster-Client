    ...
    <footer className="bg-base-200 text-base-content px-10 py-12">
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-10 text-center md:text-left">
        <div className="flex flex-col items-center md:items-start gap-3">
          ...
          <p className="text-gray-500 text-lg max-w-xs">
            ...
            movies from all genres. This site is very helpful for movie lovers.
          </p>
        </div>
        ...
        <div className="flex flex-col items-center md:items-start gap-5">
          ...
          <div className="flex gap-5">
            <img className="w-7 h-7 cursor-pointer bg-white" src={twitter} alt="" />
      ...
      <div className="mt-10 text-center">
        <p className="text-sm text-gray-500">
          ...
          <span className="font-semibold">MovieMaster</span>
        </p>
      </div>
    </footer>
  );
